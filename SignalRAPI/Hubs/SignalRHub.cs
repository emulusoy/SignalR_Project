...
namespace SignalRAPI.Hubs
{
    public class SignalRHub:Hub
    {
        ...
        public async Task SendProgress()
        {
            ...
            var value9 = _productService.TProductPriceAvg();
            await Clients.All.SendAsync("ReceiveProductPriceBySteakBurger", value9);

            var value10 = _productService.TProductCountByCategoryNameHamburger();
            await Clients.All.SendAsync("ReceiveTotalPriceByDrinkCategory", value10);

            var value11 = _productService.TProductCountByCategoryNameDrink();
